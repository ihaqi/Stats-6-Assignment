...
L <- list("watch_wd","watch_wd_sq","watch_we", "watch_we_sq", "play_wd", "play_wd_sq", "play_we", "play_we_sq", "sp_wd", "sp_wd_sq", "sp_we", "sp_we_sq", "comp_wd", "comp_wd_sq","comp_we","comp_we_sq")

l <- list("watch_wd","watch_we", "play_wd", "play_we", "comp_wd", "comp_we", "sp_wd", "sp_we")

for (i in 1:length(l)){
  print(round(table.maker(model.maker(clean,l[i],control.vars = F)),2))
}
...
```{r ploting the data eith p values}
