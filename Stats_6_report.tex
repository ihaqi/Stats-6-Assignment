...
% Essential manuscript parts
  ...
  \affiliation{
    \vspace{0.5cm}
          ...
          \textsuperscript{2} student number:\\
          \textsuperscript{3} student number:  }

  \authornote{
    Correspondence concerning this article should be addressed to Gustavo
    Villca Ponce, Tiensestraat 102, 3000 Leuven. E-mail:
    \href{mailto:gustavo.villcaponce@student.kuleuven.be}{\nolinkurl{gustavo.villcaponce@student.kuleuven.be}}
  }
