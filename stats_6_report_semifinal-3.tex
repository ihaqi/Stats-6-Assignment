...
{[}\ref{fig:plotpsecond}{]} respectively. Please note that the plots'
axes scales defer in the figures. Also note that although the p values
...
they are rather an approximate for the corresponding histograms.
...
\caption{BLAH BLAH BLAH Distribution of P values for different combinations of data for the linear component of the regression model of game play on the weekdays. Note that the curve does not represent the true probability distribution of the p values.}\label{fig:heat-d-data}
\end{figure}
\begin{figure}
