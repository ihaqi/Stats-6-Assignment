...
Two models had diverse distributions of p values. Specifically, the distributions of p values of the purely linear model of weekday game usage resulted in the histogram in Figure\ \@ref(fig:Hist.datadriven.5)
```{r Hist.datadriven.5, fig.cap = "papaja's APA6 template is available through the RStudio menues.", fig.align = "center"}
plot(Hist.datadriven.5)
```

The distributions of p values of the linear+quadratic model of weekday game usage resulted in the histogram in Figure\ \@ref(fig:Hist.datadriven.5).

```{r Hist.datadriven.6, fig.cap = "papaja's APA6 template is available through the RStudio menues.", fig.align = "center"}
plot(Hist.datadriven.6)
```
