...
histogram.data.driven.1 <- densityplot(data.combinations.p[5,]/64, breaks = 10, xlim = xlim.d, ylim = ylim.d )
histogram.data.driven.2 <- densityplot(data.combinations.p[13,]), breaks = 10, xlim = xlim.d, ylim = ylim.d*5)

ddd <- density(data.combinations.p[13,])
plot(ddd)
...
Two models had diverse distributions of p values. Specifically, the distributions of p values of the linear component of the regression model of weekday game play resulted in the histogram in Figure\ \@ref(fig:Histdatadriven1)
...
The distributions of p values of the linear component of the regression model of weekday smartphone usage resulted in the histogram in Figure\ \@ref(fig:Histdatadriven2).
