...
```{r, heat-d-data, fig.cap = "Heat map of Cohen's d for different choices of variable coding. Rows represents the coresponding rows in Table 1 and 2 and each column is for one of the 64 different data combinations.", fig.align = "center", fig.width=8}
...
```{r, heat-dd-model, fig.cap = "BLAH BLAH BLAH Distribution of P values for different combinations of data for the linear component of the regression model of game play on the weekdays. Note that the curve does not represent the true probability distribution of the p values.", fig.align = "center", fig.width=8}
...
```{r, heat-d-model, fig.cap = "BLAH BLAH BLAH Distribution of P values for different combinations of data for the linear component of the regression model of game play on the weekdays. Note that the curve does not represent the true probability distribution of the p values.", fig.align = "center", fig.width=8}
...
```{r, heat-p-data, fig.cap = "Heat map of p values for different choices of variable coding. Rows represents the coresponding rows in Table 1 and 2 and each column is for one of the 64 different data combinations.", fig.align = "center", fig.width=8}
